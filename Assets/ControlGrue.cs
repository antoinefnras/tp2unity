...
public class ControlGrue : MonoBehaviour
{
    ...
    public GameObject CameraCabine;     // Déclaration de 3 caméras
    public GameObject CameraChariot;
    public GameObject CameraArriere;
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.A))                  // Début du bloc de gestion des caméras
        {
            Camera.main.gameObject.SetActive(false); 
            CameraCabine.SetActive(true);
        }
        if (Input.GetKey(KeyCode.Z))
        {
            Camera.main.gameObject.SetActive(false); 
            CameraChariot.SetActive(true);
        }
